...
/**
 * This is the item provider adapter for a {@link internship.moda.fig1.ModaNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModaNodeItemProvider extends NamedElementItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ModaNodeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((ModaNode) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_ModaNode_type")
				: getString("_UI_ModaNode_type") + " " + label;
	}
