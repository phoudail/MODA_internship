 ...
 * </p>
 * <ul>
 *   <li>{@link internship.moda.fig1.impl.MeasuredDataImpl#getSoftware <em>Software</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MeasuredDataImpl extends DataImpl implements MeasuredData {
	/**
	...
	protected EClass eStaticClass() {
		return Fig1Package.Literals.MEASURED_DATA;
	}
		...
		if (software != null && software.eIsProxy()) {
			...
			if (software != oldSoftware) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, Fig1Package.MEASURED_DATA__SOFTWARE,
	...
	public void setSoftware(Software newSoftware) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Fig1Package.MEASURED_DATA__SOFTWARE, oldSoftware,
					software));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Fig1Package.MEASURED_DATA__SOFTWARE:
			if (resolve)
				return getSoftware();
